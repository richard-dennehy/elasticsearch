...
public abstract class C2IdOpTestCase extends ESRestTestCase {
    ...
    public static ElasticsearchCluster cluster = ElasticsearchCluster.local()
        ...
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.op.authorization_endpoint", () -> c2id.getC2OPSslUrl() + "/c2id-login")
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.op.token_endpoint", () -> c2id.getC2IssuerSslUrl() + "/token")
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.op.userinfo_endpoint", () -> c2id.getC2IssuerSslUrl() + "/userinfo")
        ...
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.http.proxy.scheme", "https")
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.http.proxy.host", "127.0.0.1")
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.http.proxy.port", () -> proxy.getTlsPort().toString())
        .setting("xpack.security.authc.realms.oidc.c2id-proxy.ssl.keystore.path", "testnode.jks")
        ...
        .setting("xpack.security.authc.realms.jwt.op-jwt-proxy.pkc_jwkset_path", () -> c2id.getC2IssuerSslUrl() + "/jwks.json")
        ...
        .keystore("xpack.security.authc.realms.oidc.c2id-proxy.ssl.keystore.secure_password", "testnode")
